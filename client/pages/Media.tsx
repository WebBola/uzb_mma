...
export default function Media() {
  return (
    <div className="page-transition w-full min-w-0 overflow-x-hidden">
      <section className="w-full min-w-0 border-b separator-line bg-black py-12 sm:py-16 md:py-20">
        <div className={`${sectionShell} text-center`}>
          <p className="mb-3 text-xs uppercase tracking-[0.2em] text-gray-500 sm:text-sm">
            Press & broadcasts
          </p>
          <h1 className="mb-4 max-w-4xl text-3xl font-extrabold uppercase tracking-tight text-white sm:text-4xl md:text-5xl lg:text-6xl">
      ...
      <section className="w-full min-w-0 border-b separator-line bg-black py-12 sm:py-16 md:py-20">
        <div className={sectionShell}>
          <div className="mb-8 flex w-full max-w-3xl flex-col items-center text-center sm:mb-10">
            <div className="mb-3 inline-flex h-10 w-10 items-center justify-center rounded-full border border-amber-500/30 bg-gradient-to-br from-[#ff9f00]/20 to-transparent text-electric-blue shadow-[0_0_24px_rgba(255,159,0,0.15)] sm:h-12 sm:w-12">
              <Camera className="h-5 w-5 sm:h-6 sm:w-6" />
            </div>
            <h2 className="text-xl font-bold uppercase tracking-wide text-white sm:text-2xl md:text-3xl">
              Photo gallery
            </h2>
            <div className="mt-3 h-px w-16 bg-gradient-to-r from-transparent via-[#ff9f00]/80 to-transparent" />
          </div>
          <div className="grid w-full min-w-0 grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 xl:grid-cols-3">
            {gallery.map((item) => (
              <figure
                key={item.src}
                className="group glass-card min-w-0 overflow-hidden rounded-[var(--radius)] border-0"
              >
                ...
                <figcaption className="border-t border-white/10 px-3 py-3 text-xs text-gray-400 sm:px-4 sm:py-3.5 sm:text-sm">
                  {item.caption}
                </figcaption>
              </figure>
            ))}
          ...
          <div className="grid w-full min-w-0 grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-2">
            {broadcasts.map((item) => (
              <a
                ...
                className="group glass-card flex min-w-0 flex-col gap-3 p-5 sm:p-6"
              >
                <div className="flex aspect-video items-center justify-center rounded-md border border-white/10 bg-black/50 text-xs uppercase tracking-wider text-gray-600">
                  YouTube
                </div>
                <h3 className="text-base font-semibold text-white transition-colors group-hover:text-electric-blue sm:text-lg">
                  {item.title}
                </h3>
                <p className="flex-1 text-xs leading-relaxed text-gray-400 sm:text-sm">
                  {item.description}
                </p>
                <span className="inline-flex items-center gap-1 text-xs font-semibold text-electric-blue sm:text-sm">
                  Watch
      ...
      <section className="w-full min-w-0 bg-black py-12 sm:py-16 md:py-20">
        <div className={sectionShell}>
          <div className="mb-6 flex w-full max-w-3xl flex-col items-center text-center sm:mb-8">
            <div className="mb-3 inline-flex h-10 w-10 items-center justify-center rounded-full border border-amber-500/30 bg-gradient-to-br from-[#ff9f00]/20 to-transparent text-electric-blue shadow-[0_0_24px_rgba(255,159,0,0.15)] sm:h-12 sm:w-12">
          ...
          <div className="glass-card w-full max-w-3xl space-y-4 p-6 text-center sm:p-8">
            ...
            <div className="flex flex-col flex-wrap items-center justify-center gap-3 text-sm sm:flex-row sm:gap-6">
              <a
                href="mailto:press@uzb-mma.uz"
                className="break-all font-semibold text-electric-blue hover:underline sm:break-normal"
              >
                press@uzb-mma.uz
              </a>
              ...
              <a
                ...
                className="text-center text-gray-300 transition-colors hover:text-white sm:text-left"
              >
                +998 (71) 234-5678 — Media desk
              </a>
            </div>
          </div>
        </div>
